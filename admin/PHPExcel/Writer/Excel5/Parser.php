...
//		}
	...
	function _fact()
	{
		...
		throw new \PhpOffice\PhpSpreadsheet\Writer\Exception("Syntax error: ".$this->_current_token.
		...
		/**/
			if ($num_args > 0) {
					...
					$this->_current_token == ";")
				{
					...
					throw new \PhpOffice\PhpSpreadsheet\Writer\Exception("Syntax error: comma expected in ".
