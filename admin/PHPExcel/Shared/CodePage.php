 ...
 public static function NumberToName($codePage = 1252)
	{
		switch ($codePage) {
			...
			case 720:	throw new \PhpOffice\PhpSpreadsheet\Exception('Code page 720 not supported.');
													break;	//	OEM Arabic
			...
			case 32769:	throw new \PhpOffice\PhpSpreadsheet\Exception('Code page 32769 not supported.');
