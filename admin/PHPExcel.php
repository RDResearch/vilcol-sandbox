...
class Spreadsheet
{
 ...
 public function getSheetByCodeName($pName = '')
	...
	public function __construct()
	{
		...
		$this->_calculationEngine	= \PhpOffice\PhpSpreadsheet\Calculation\Calculation::getInstance($this);
		$this->_workSheetCollection[] = new \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet($this);

        // Create document properties
        $this->_properties = new \PhpOffice\PhpSpreadsheet\Document\Properties();

        // Create document security
        $this->_security = new \PhpOffice\PhpSpreadsheet\Document\Security();

        // Create the cellXf supervisor
        $this->_cellXfSupervisor = new \PhpOffice\PhpSpreadsheet\Style\Style(\true);
    ...
    public function __destruct() {
        \PhpOffice\PhpSpreadsheet\Calculation\Calculation::unsetInstance($this);
 ...
 public function getCalculationEngine()
     ...
     *
     * @param  string $pValue
     * @return \PhpOffice\PhpSpreadsheet\Style\Style|false
     */
    ...
    {
        return \in_array($pCellStyle, $this->_cellXfCollection, \true);
    }
    ...
    public function garbageCollect()
    {
        ...
        if (empty($this->_cellXfCollection)) {
            $this->_cellXfCollection[] = new \PhpOffice\PhpSpreadsheet\Style\Style();
        }
